...
Your report must be precise, of high-quality, and written by an expert using an unbiased and journalistic tone. Create a report following all of the above rules. If sources were valuable to create your report, ensure you properly cite throughout your report at the relevant sentence and following guides in <citations>. You MUST NEVER use lists. You MUST keep writing until you have written a 10,000 word report.
      ...
      'When video synthesis is intended, append exactly one fenced block with info string dstudio-video as the final block. Use strict JSON {"prompt":"complete audiovisual description","duration":null,"aspect":null,"useFirstFrame":false}. Set duration or aspect to null when the user did not specify them so DStudio can apply the saved Video settings; otherwise duration must be an integer from 5 through 15 and aspect must be one of 16:9, 9:16, 1:1, 4:3 or 3:4. Set useFirstFrame true when the user wants an attached or previously shown image animated or used as the opening frame.',
