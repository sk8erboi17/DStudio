...
ds4_upstream: superpowers/skills/dispatching-parallel-agents
...
> Original skill id: `dispatching-parallel-agents`.
> DStudio catalog id: `superpowers-dispatching-parallel-agents`.
