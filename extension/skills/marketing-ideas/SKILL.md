...
description: |
  When the user needs marketing ideas, inspiration, or strategies for their SaaS or
  software product. Also use when the user asks for 'marketing ideas,' 'growth ideas,'
  'how to market,' 'marketing strategies,' 'marketing tactics,' 'ways to promote,' 'ideas
  to grow,' 'what else can I try,' 'I don't know how to market this,' 'brainstorm
  ...
  execution, see the relevant skill (ads, social, emails, etc.).
modes: [agent, marketing]
ds4_category: marketing-strategy
ds4_local_mode: native
ds4_output_kinds: markdown
ds4_upstream: marketingskills/marketing-ideas
