...
name: referrals
description: |
  When the user wants to create, optimize, or analyze a referral program, affiliate
  ...
  or 'affiliate payout.' Use this whenever someone wants existing users or partners to
  bring in new customers. For launch-specific virality, see launch.
modes: [agent, marketing]
ds4_category: growth-retention
ds4_local_mode: native
ds4_output_kinds: markdown
ds4_upstream: marketingskills/referrals
