...
description: |
  ...
  Also use when the user mentions 'launch,' 'Product Hunt,' 'feature release,'
  'announcement,' 'go-to-market,' 'beta launch,' 'early access,' 'waitlist,' 'product
  update,' 'how do I launch this,' 'launch checklist,' 'GTM plan,' or 'we're about to
  ship.' Use this whenever someone is preparing to release something publicly. For ongoing
  marketing after launch, see marketing-ideas.
modes: [agent, marketing]
ds4_category: sales-gtm
ds4_local_mode: native
ds4_output_kinds: markdown
ds4_upstream: marketingskills/launch
