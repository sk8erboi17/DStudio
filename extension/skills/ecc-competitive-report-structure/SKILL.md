...
ds4_provider: ecc
ds4_upstream: ecc/.agents/skills/competitive-report-structure
...
> Original skill id: `competitive-report-structure`.
> DStudio catalog id: `ecc-competitive-report-structure`.
