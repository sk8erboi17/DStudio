# Web: API access boundary review

## Engagement brief
You are working inside an authorized local assessment workspace for Northstar-01.

Category: Web
Difficulty: hard
Case ID: web-hard-01-api-access-boundary

## Objective
Handle noisy traffic, decoy endpoints, and multiple application layers; separate configuration drift from real exposure.
...
The operational theme is REST routes and access logs.
