# Api Access Boundary Review Target

This is a curated local benchmark workspace for DStudio GSA. It is written as a source review target, not as a puzzle. The code and artifacts describe a realistic multi-tenant API service used by the ledger team.
