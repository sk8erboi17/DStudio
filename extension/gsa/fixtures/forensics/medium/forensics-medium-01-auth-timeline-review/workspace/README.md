# Forensics: Authentication timeline review

## Engagement brief
You are working inside an authorized local assessment workspace for Harbor-01.

Category: Forensics
Difficulty: medium
Case ID: forensics-medium-01-auth-timeline-review

## Objective
Correlate logs from multiple sources and distinguish confirmed events from suspicious but unsupported activity.
...
The operational theme is authentication logs.
