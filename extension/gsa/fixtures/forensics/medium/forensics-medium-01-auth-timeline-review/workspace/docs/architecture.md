...
The ledger team owns this incident timeline correlation pipeline. The code was extracted from a larger internal service and stripped of deployment secrets. The remaining files preserve enough context for local review: request/data flow, policy boundaries, and operator notes.
