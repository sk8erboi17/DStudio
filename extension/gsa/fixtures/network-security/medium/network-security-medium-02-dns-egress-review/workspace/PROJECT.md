# Dns Egress Review Review Target

This is a curated local benchmark workspace for DStudio GSA. It is written as a source review target, not as a puzzle. The code and artifacts describe a realistic network policy decision engine used by the broker team.
