# Network Security: DNS egress review

## Engagement brief
You are working inside an authorized local assessment workspace for Metro-02.

Category: Network Security
Difficulty: medium
Case ID: network-security-medium-02-dns-egress-review

## Objective
Correlate flows, DNS, firewall records, and service inventory before deciding what is exposed.
...
The operational theme is DNS logs and resolver policy.
