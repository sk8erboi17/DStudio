# Certificate Transparency Review Review Target

This is a curated local benchmark workspace for DStudio GSA. It is written as a source review target, not as a puzzle. The code and artifacts describe a realistic entity resolution and source confidence pipeline used by the relay team.

## Repository map
- `src/`: implementation code in Python.
