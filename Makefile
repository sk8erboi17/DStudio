...
.PHONY: all run check check-fast check-real test-lan-unit test-ui-contract test-ui-browser test-http-lan test-gsa-bench-validate test-real-search-research test-real-remote clean app windows install-desktop uninstall-desktop
...
check-fast: $(BIN) test-lan-unit test-ui-contract test-ui-browser test-http-lan test-gsa-bench-validate
